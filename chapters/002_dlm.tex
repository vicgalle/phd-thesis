...
\subsubsection{The Nerlove-Arrow model}
...
\subsubsection{Model specification}\label{sec:model}
...
\subsubsection{Modularity and additional structure}
...
\subsubsection{Model estimation and forecasting}\label{s:MCMC}
...
\subsubsection{Budget allocation. Model-based solutions}\label{section: budget allocation}
