...
In particular, we propose to extend $Q$-learning from an ARA \parencite{rios2009adversarial} perspective. % through a level-$k$ 
...
%To handle it, we propose using a level-$k$ scheme \parencite{rios2009adversarial}
...
from different perspectives. For example,
 ...
 %that standard common knowledge assumptions \parencite{varoufakis} are considered.
