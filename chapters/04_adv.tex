...
and  was pioneered by \parencite{dalvi2004adversarial}.
...
Dalvi et al. \parencite{dalvi2004adversarial} provided a pioneering approach to enhance classification algorithms when an adversary is present, calling it adversarial classification (AC).
...
%\end{equation}
Ref. \parencite{dalvi2004adversarial} focuses on  a utility sensitive Naive Bayes algorithm \parencite{elkan2001foundations}.
...
However, \parencite{dalvi2004adversarial} considers sufficient to use these three.
...
\parencite{dalvi2004adversarial}, AC has been predated by game-theoretic approaches, as reviewed in \parencite{biggio2014security} or \parencite{li2014feature}.
...
could lead to a hierarchy of decision making problems, described in \parencite{rios2012adversarial} in a simpler context. 
